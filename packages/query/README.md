...
```html
<script src="https://cdn.jsdelivr.net/npm/@sometic/query@3.0.2/dist/cdn/sometic-query.iife.js"></script>
<script>
...
```html
<script type="module">
    import { createQueryClient } from "https://cdn.jsdelivr.net/npm/@sometic/query@3.0.2/dist/cdn/sometic-query.esm.js";
