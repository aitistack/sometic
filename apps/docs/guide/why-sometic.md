...
Sometic is a **portable application behavior system**: shared controllers for UI, forms, auth, and HTTP — with thin framework adapters and **your** styling system.

It is **not** another pre-styled React component kit. If the first thing you need is buttons that look like a brand out of the box, use a visual library. If you need **one behavior model that survives a framework change**, keep reading.
