...
| UI engines + adapters | Button family, Field/Input family, Selection (Checkbox, Switch, Radio, Select, **Combobox**), Overlay (Dialog, Popover, Tooltip, Toast, Alert, **Menu**, **Context menu**, **Drawer**), Structure (**Tabs**, **Accordion**, **Breadcrumb**, **Command palette**, **Tree**), Feedback (**Progress**, **Spinner**, **Skeleton**, **Badge**), Form adapters |
| Adapters              | `@sometic/react` (full Wave A components including structure), `@sometic/vue` (button/field/input/form/overlay/structure components), `@sometic/elements` (CEs below) |
