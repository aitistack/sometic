...
```html [CDN Simple]
<script src="https://cdn.jsdelivr.net/npm/@sometic/auth@1.2.2/dist/cdn/sometic-auth.iife.js"></script>
<script>
...
```html [CDN Module]
<script type="module">
    import { createAuth } from "https://cdn.jsdelivr.net/npm/@sometic/auth@1.2.2/dist/cdn/sometic-auth.esm.js";
